...
public final class JPASearchFactoryAdapter
	...
	private Map<Class<?>, ExtendedTypeMetadata> rehashedTypeMetadataForIndexRoot;
	private Map<Class<?>, Set<Class<?>>> containedInIndexOf;
	private ExtendedSearchIntegrator searchIntegrator;

	private EventModelParser eventModelParser = new AnnotationEventModelParser();
	...
	public final void init() {
		...
		this.indexRelevantEntities = Collections.unmodifiableSet(
				MetadataUtil.calculateIndexRelevantEntities(
						extendedTypeMetadatas, entities
				)
		);
		this.idProperties = MetadataUtil.calculateIdProperties( extendedTypeMetadatas );
		this.containedInIndexOf = MetadataUtil.calculateInIndexOf( extendedTypeMetadatas, entities );
	...
	public JPASearchFactoryAdapter setEntities(List<Class<?>> entities) {
	...
	public EventModelParser getEventModelParser() {
		return eventModelParser;
	}

	public JPASearchFactoryAdapter setEventModelParser(EventModelParser eventModelParser) {
		this.eventModelParser = eventModelParser;
		return this;
	}
	...
	@Override
	public HSearchQuery createQuery(
			QueryDescriptor descriptor, Class<?>... targetedEntities) {
		return this.searchFactory.createQuery( descriptor, targetedEntities );
	}
